<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Admin.Master" AutoEventWireup="true" CodeBehind="QLAdmin.aspx.cs" Inherits="QLBH_BANDIENTHOAI.Admin.QLAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>1</td>
                                                <td>
                                                    <div class="m-r-10"><img src="TemplateAdmin/assets/images/product-pic.jpg" alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #1 </td>
                                                <td>id000001 </td>
                                                <td>20</td>
                                            ...
                                            <tr>
                                                <td>2</td>
                                                <td>
                                                    <div class="m-r-10"><img src="TemplateAdmin/assets/images/product-pic-2.jpg" alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #2 </td>
                                                <td>id000002 </td>
                                                <td>12</td>
                                            ...
                                            <tr>
                                                <td>3</td>
                                                <td>
                                                    <div class="m-r-10"><img src="TemplateAdmin/assets/images/product-pic-3.jpg" alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #3 </td>
                                                <td>id000003 </td>
                                                <td>23</td>
                                            ...
                                            <tr>
                                                <td>4</td>
                                                <td>
                                                    <div class="m-r-10"><img src="TemplateAdmin/assets/images/product-pic-4.jpg" alt="user" class="rounded" width="45"></div>
                                                </td>
                                                <td>Product #4 </td>
                                                <td>id000004 </td>
                                                <td>34</td>
    ...
    <!-- slimscroll js-->
    <script src="TemplateAdmin/assets/vendor/slimscroll/jquery.slimscroll.js"></script>
    <!-- chartjs js-->
    <script src="TemplateAdmin/assets/vendor/charts/charts-bundle/Chart.bundle.js"></script>
    <script src="TemplateAdmin/assets/vendor/charts/charts-bundle/chartjs.js"></script>
   
    <!-- main js-->
    <script src="TemplateAdmin/assets/libs/js/main-js.js"></script>
    <!-- jvactormap js-->
    <script src="TemplateAdmin/assets/vendor/jvectormap/jquery-jvectormap-2.0.2.min.js"></script>
    <script src="TemplateAdmin/assets/vendor/jvectormap/jquery-jvectormap-world-mill-en.js"></script>
    <!-- sparkline js-->
    <script src="TemplateAdmin/assets/vendor/charts/sparkline/jquery.sparkline.js"></script>
    <script src="TemplateAdmin/assets/vendor/charts/sparkline/spark-js.js"></script>
     <!-- dashboard sales js-->
    <script src="TemplateAdmin/assets/libs/js/dashboard-sales.js"></script>
</asp:Content>
